...
def midCase(nums0):
    ...
    drawGraph(nums, time,'Insertion Sort', "Caso Medio",211, "Nº de Elementos", "Tempo(s)")
...
def worseCase(nums1):
    ...
    drawGraph(nums, time1, 'Insertion Sort', "Pior Caso",211, "Nº de Elementos", "Tempo(s)")
...
def bestCase(nums2):
    ...
    drawGraph(nums, time2, 'Insertion Sort', "Melhor Caso",211, "Nº de Elementos", "Tempo(s)")
